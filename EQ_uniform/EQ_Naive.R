...
# ./EQ_Naive.R vcf=/media/datn/data/DatProjects/vn_array/data/vn_504_maf_0.01/MAF_0.01.chr22_vn504_Biallelic.SNP_PHASED_SHAPEIT4_no_chr_version_dbSNP_151.vcf.gz size=20000 out=chr18_EQ_Naive_20000.txt

args = commandArgs(trailingOnly=TRUE)
syntax='\nUsage:\t./EQ_Naive.R vcf=path/to/vcf.gz size=size out=output_name.txt\n\nInput parameters are:\n\tvcf=path/to/vcf.gz\n\tsize=number_of_tagSNP : for example: size=20000\n\tout=out_file_name.txt : output file name, defaut value is: "EQ_Naive_array_size.txt"\n\n'
...
if ( is.na(out_name)) out_name = paste0( "EQ_Naive_array_", (array_size), ".txt")
